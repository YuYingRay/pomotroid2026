<template>
  <div class="Container">
    <p class="Drawer-heading">{{ $t('timerSettings.title') }}</p>
    <div class="Setting-wrapper">
      <p class="Setting-title">{{ $t('timerSettings.focusTime') }}</p>
    ...
    <div class="Setting-wrapper">
      <p class="Setting-title">{{ $t('timerSettings.shortBreakTime') }}</p>
    ...
    <div class="Setting-wrapper">
      <p class="Setting-title">{{ $t('timerSettings.longBreakTime') }}</p>
    ...
    <div class="Setting-wrapper">
      <p class="Setting-title">{{ $t('timerSettings.rounds') }}</p>
    ...
    <div class="Setting-wrapper">
      <p class="TextButton" @click="resetDefaults">{{ $t('timerSettings.resetDefaults') }}</p>
    </div>
  </div>
</template>
